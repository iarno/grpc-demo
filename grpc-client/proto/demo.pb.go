...
type DemoReq struct {
	...
	A string `protobuf:"bytes,1,opt,name=a,proto3" json:"a,omitempty"` // 请求参数a
}
...
type DemoRsp struct {
	...
	Rel string `protobuf:"bytes,1,opt,name=rel,proto3" json:"rel,omitempty"` // 返回参数值
}
...
var file_demo_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x17, 0x0a, 0x07, 0x44, 0x65, 0x6d, 0x6f, 0x52, 0x65, 0x71, 0x12, 0x0c,
	0x0a, 0x01, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x01, 0x61, 0x22, 0x1b, 0x0a, 0x07,
	0x44, 0x65, 0x6d, 0x6f, 0x52, 0x73, 0x70, 0x12, 0x10, 0x0a, 0x03, 0x72, 0x65, 0x6c, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x72, 0x65, 0x6c, 0x32, 0x33, 0x0a, 0x04, 0x44, 0x65, 0x6d,
	0x6f, 0x12, 0x2b, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x44, 0x61, 0x74, 0x61, 0x12, 0x0e, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x44, 0x65, 0x6d, 0x6f, 0x52, 0x65, 0x71, 0x1a, 0x0e, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x44, 0x65, 0x6d, 0x6f, 0x52, 0x73, 0x70, 0x22, 0x00, 0x42, 0x09,
...
var file_demo_proto_depIdxs = []int32{
	0, // 0: proto.Demo.GetData:input_type -> proto.DemoReq
	1, // 1: proto.Demo.GetData:output_type -> proto.DemoRsp
...
func (c *demoClient) GetData(ctx context.Context, in *DemoReq, opts ...grpc.CallOption) (*DemoRsp, error) {
	out := new(DemoRsp)
	err := c.cc.Invoke(ctx, "/proto.Demo/GetData", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedDemoServer) GetData(context.Context, *DemoReq) (*DemoRsp, error) {
...
func _Demo_GetData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DemoReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DemoServer).GetData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Demo/GetData",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DemoServer).GetData(ctx, req.(*DemoReq))
	}
